...
<h5 class="blue-text">Edit Barang Masuk</h2>
	...
	<div class="row"> 
		<div class="input-field col s5">
			...
			<label class="active pink-text" for="expired">Expired</label>
		</div>
		<div class="column col s5 right">
	...
	<div class="row">
		<div class="column input-field col s5">
			...
			<label class="active pink-text" for="harga">Harga Beli</label>
		</div>
		<div class="column col s5 right">
			<input type="number" id="harga_jual" placeholder="Harga Jual" value="<?php echo $harga_jual; ?>" required>
			<label class="active pink-text" for="harga_jual">Harga Jual</label>
		</div>
	</div>
	<div class="row">
...
<h5 class="blue-text">Tambah Barang Masuk</h2>
	<div class="row">
		<div class="column col s5">
			<i class="material-icons Small prefix">local_mall</i>
			...
			<div class="column input-field col s5 right">
				<i class="material-icons Small prefix">shopping_basket</i>
			<label class="pink-text " for="stok">Stok</label>
	...
	<div class="row"> 
		<div class="column col s5 right">
			...
			<label class="pink-text">ID Supplier</label>
			<select class="browser-default waves-effect waves-light" id="id_supplier">
				<option value="">- Pilih -</option>
				<?php require'../connect.php';
					try{
	...
	<div class="row"> 
		<div class="input-field col s5">
			<i class="material-icons Small prefix">event_note</i>
			<label class="active pink-text">Expired</label>
			<input  type="date" id="expired"/>
			
		</div>
		<div class="column col s5 right">
			<i class="material-icons Small prefix">event_available</i>
			<label class="active pink-text">Tgl-Masuk</label>
			<input type="text" id="tgl_masuk" class="active pink-text" readonly="readonly" value="<?php echo date("Y-m-d");?>">
		</div>
	</div>
	<div class="row">
		<div class="column input-field col s5">
			...
			<label class="pink-text" for="harga">Harga Beli</label>
		</div>
		<div class="column col s5 right">
			<i class="material-icons Small prefix">attach_money</i>
			<label for="harga_jual" class="pink-text">Harga Jual</label>
