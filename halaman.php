...
<head>
	...
	<link href="matrializer/css/materialize.min.css" media="all" rel="stylesheet" type="text/css" />
  <link href="https://fonts.googleapis.com/icon?family=Material+Icons" rel="stylesheet">
	...
	<div class="row">
        ...
        <!-- Grey navigation panel -->
			<ul class="collection">
				<a id="barangmasuk" class="collection-item">Data Barang-Masuk
					<i class="secondary-content mdi-action-add-shopping-cart Small"></i></a>
        		<a id="dokter" class="collection-item">Data Dokter
					<i class="secondary-content  material-icons Small">assignment_ind</i></a>
        		<a id="medicine" class="collection-item">Data Obat<i class="secondary-content  material-icons Small">local_pharmacy</i></a>
				<a id="pasien" class="collection-item">Data Pasien<i class="secondary-content  material-icons Small">group</i></a>
				<a id="supplier" class="collection-item">Data Supplier<i class="secondary-content  material-icons Small">local_shipping</i></a>
				<a id="transaksi" class="collection-item">Data Transaksi <i class="secondary-content  material-icons Small">attach_money</i></a>
				<a id="jasa" class="collection-item">Data Jasa<i class="secondary-content  material-icons Small">local_hospital</i></a>
				<a id="report" class="collection-item">Report<i class="secondary-content  material-icons Small">print</i></a>
	   ...
	   <div class="column col s9">
		    <div id="latar_belakang" class="row "><?php include"latar_belakang.php";?></div>
	   </div>
	  <div class="column col s9">
		<div id="cruddata" class="row"></div>
	...
	<script type="text/javascript">
		...
		$("#home").click(function(){
			$("#latar_belakang").load("latar_belakang.php");
			$("#cruddata").hide();
			$("#viewdata").hide();
		});
		...
		$("#viewdata").on("click","#cari_brgmasuk",function(){
			var cari = $("#cari_brgmasuk_value").val();
			alert(cari);
			$.ajax({
