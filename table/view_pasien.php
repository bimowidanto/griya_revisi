<table>
		<th><a class="waves-effect waves-light" id="tambah_pasien">
			<i class="material-icons Small left">person_add</i></a>tambah</th>
	...
	<table class="striped">
		<thead >
			<tr class="#4fc3f7 light-blue lighten-2 centered">
				<th >Id Pasien</th>
				<th>Nama</th>
				<th>Jenis Kelamin</th>
				<th>No.tlp</th>
		...
		if(@$_POST['cari_pasien']!=null || @$_POST['cari_pasien']!=""){
				$cari = @$_POST['cari_pasien'];
				 $sql="SELECT id_pasien,nama_pasien,alamat,no_telp,jenis_kelamin FROM tbl_pasien WHERE nama_pasien LIKE'%$cari%' $limit";
			}else{
		...
		?>
					<tr>
						...
						<td width="100px" align="center"><a class="edit_pasien btn-floating waves-effect orange"
							...
							."=".$data['alamat'];?>">
							<i class="mdi-editor-mode-edit #00bfa5 teal accent-4"></i></a>
